...
def play(choice):
    ...
    # here a Computer makes a random choice using random function
    computer_choice = random.choice(choices)
    
    # I used IF statementrs to determine the result
...
def reset_game():
    # I reset the game for a new round[reset func]
...
def create_choice_buttons():
    # I then create buttons for rock, paper, and scissors
...
# last but not least I then run the application
root.mainloop()
